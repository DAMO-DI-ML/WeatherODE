...
from weatherode.pretrain.dataset import (
    Forecast,
    IndividualForecastDataIter,
    NpyReader,
    ShuffleIterableDataset,
)
from weatherode.utils.data_utils import get_region_info
...
class RegionalForecastDataModule(LightningDataModule):
    ...
    Args:
        ...
        region (str, optional): The name of the region to finetune WeatherODE on.
